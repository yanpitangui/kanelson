...
public class QuestionIndexSpecs : PersistenceTestKit
{
    ...
    private readonly TestActorRef<QuestionIndexActor> _testActor;
    public QuestionIndexSpecs()
    {

        var props = Props.Create<QuestionIndexActor>("question-index");
        _testActor = new TestActorRef<QuestionIndexActor>(Sys, props);
